...
export const TurfGreen = "#1ba41f";
export const Transparent = "#ffffff";
export const LightGray = "#e6ecef";
export const DarkBlue = "#00558c";
export const LimeGreen = "#ccd814";
export const SkyBlue = "#019be5";
...
export const Roboto11PtSize = "11rem";
export const Roboto28PtSize = "28rem";
export const Roboto22PtSize = "22rem";
export const Roboto18PtSize = "18rem";
export const Roboto16PtSize = "16rem";
export const Roboto12PtSize = "12rem";
export const Roboto120PtSize = "120rem";
export const Roboto50PtSize = "50rem";
export const Roboto90PtSize = "90rem";
export const Roboto67PtSize = "67rem";